...
public class ImageCacheManager {
	...
	/**
	 * Volley recommends in-memory L1 cache but both a disk and memory cache are provided. Volley includes a L2 disk cache out of the box
	 * but you can technically use a disk cache as an L1 cache provided you can live with potential i/o blocking.
	 * 
	 */
