...
public class CustomDialogForCheckQuery {
    ...
    private Spinner checkTypeSpin, stateSpin;
    private Button okButton, cancelButton;

    private Calendar c = Calendar.getInstance();

    private CustomDialogForCheckQuery(Context context) {
        super();
        this.mContext = context;
        View customView = LayoutInflater.from(context).inflate(R.layout.custom_dialog_for_check_query, null);
        ad = new Dialog(mContext, R.style.CheckDialog);
        ad.setContentView(customView);
        ad.show();

        checkNo = (EditText) customView.findViewById(R.id.checkNo);
    ...
    public static class Builder {
        ...
        public CustomDialogForCheckQuery show() {
            CustomDialogForCheckQuery dialog = new CustomDialogForCheckQuery(params.context);
    ...
    public String getCheckNo() {
        return checkNo.getText().toString();
    }
