...
public class CustomDialogForSalesQuery {
    ...
    private CustomDialogForSalesQuery(Context context) {
        super();
        ...
        orderNo = (EditText) customView.findViewById(R.id.checkNo);
    ...
    public static class Builder {
        ...
        public CustomDialogForSalesQuery show() {
            CustomDialogForSalesQuery dialog = new CustomDialogForSalesQuery(params.context);
    ...
    public String getOrderNo() {
        return orderNo.getText().toString();
    }
